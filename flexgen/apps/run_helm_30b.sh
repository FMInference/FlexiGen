...
# Synthetic reasoning
time python3 helm_run.py --description synthetic_reasoning_natural:model=text_code,difficulty=easy --pad-to-seq-len 512 --model $model --percent 20 80 0 100 0 100 --gpu-batch-size 48 --num-gpu-batches 3 --cpu --max-eval-instance 512

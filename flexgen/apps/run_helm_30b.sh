...
# MMLU
time python3 helm_run.py --description mmlu:model=text,subject=abstract_algebra,data_augmentation=canonical --pad-to-seq-len 512 --model $model --percent 20 80 0 100 0 100 --gpu-batch-size 40 --num-gpu-batches 3 --cpu --max-eval-instance 100
